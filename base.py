...
def mfcc(signal,samplerate=16000,winlen=0.025,winstep=0.01,numcep=13,
    ...
    :param appendEnergy: if this is true, log of the total frame energy is appended to the beginning of the feature vector.
    ...
    if appendEnergy:
        ...
        feat = numpy.concatenate((energy[:, numpy.newaxis], feat), axis=1)
    return feat
